...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  AcWebview webview = AcWebview(url:'http://localhost:4200/');

  _MyHomePageState(){
    webview.onAction(name: 'test_action', callback: (AcWebviewChannelAction channelAction){
      channelAction.response = {"status":"success"};
    });
  }
