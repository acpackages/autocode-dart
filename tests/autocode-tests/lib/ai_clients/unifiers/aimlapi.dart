...
void testAimlApi() async {
  // 1. Create the config
  final config = AcAIClientConfig(
    model: AcEnumAIModel.openaiGpt4o, // You can change this to any model supported by AIMLAPI
    apiKey: '7458f0b57bf345649b824fec509da690', // Your AIMLAPI key
  ...
  // 2. Create the client
  final client = AcAIAmlapiClient(config: config);
