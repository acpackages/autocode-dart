...
class AcWebviewWin extends StatefulWidget{
  final String url;
  ...
  AcWebviewWin({required this.url,this.backgroundColor,super.key});
  @override
  State<AcWebviewWin> createState() => state;
...
class _AcWebviewState extends State<AcWebviewWin> {
