...
Future<void> main() async {
  ...
  dao.sqlConnection = AcSqlConnection(database: 'database/source.db');
  AcSyncSourceDatabase syncDatabase = AcSyncSourceDatabase(dao: dao,databaseType: AcEnumSqlDatabaseType.sqlite);
