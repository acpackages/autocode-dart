...
class AcWebResponse {
  ...
  static AcWebResponse internalError({
    dynamic data,
    int responseCode = AcEnumHttpResponseCode.INTERNAL_SERVER_ERROR,
  }) {
  ...
  static AcWebResponse json({
    ...
    int responseCode = AcEnumHttpResponseCode.OK,
  }) {
    final response = AcWebResponse();
    response.responseCode = responseCode;
  ...
  static AcWebResponse redirect({
    required String url,
    int responseCode = AcEnumHttpResponseCode.TEMPORARY_REDIRECT,
  }) {
    final response = AcWebResponse();
    response.responseCode = responseCode;
