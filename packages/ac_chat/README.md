...
[![Pub](https://img.shields.io/pub/v/ac_chat.svg)](https://pub.dartlang.org/packages/ac_chat)
...
- [UI Docs](https://getstream.io/chat/docs/sdk/flutter/ac_chat/introduction/)
...
Check out the [changelog on pub.dev](https://pub.dev/packages/ac_chat/changelog) to see the latest changes in the package.
...
The example is available under the [example](https://github.com/GetStream/stream-chat-flutter/tree/master/packages/ac_chat/example) folder.

## Add dependency
Add this to your package's pubspec.yaml file, use the latest version [![Pub](https://img.shields.io/pub/v/ac_chat.svg)](https://pub.dartlang.org/packages/ac_chat)
```yaml
dependencies:
 ac_chat: ^latest_version
```
...
- [AcChannelHeader](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_channel_header/)
- [StreamChannelListView](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_channel_list_view/)
- [StreamMessageInput](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_message_input/)
- [StreamMessageListView](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_message_list_view/)
- [StreamMessageWidget](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_message_widget/)
- [StreamChatTheme](https://getstream.io/chat/docs/sdk/flutter/ac_chat/stream_chat_and_theming/)
- ...
