...
abstract class JsEngine implements RustOpaqueInterface {
  ...
  static Future<JsEngine> create(
          ...
          JsEngineRuntimeOptions? runtimeOptions}) async {
    if (!LibFjs.instance.initialized) {
      await AcQuickJs.init();
    }
    return LibFjs.instance.api.crateApiEngineJsEngineCreate(
